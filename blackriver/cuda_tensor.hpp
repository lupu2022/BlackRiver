...
struct CUDATensor : public TransformerComputing {
    ...
    ComputingReturn op_layernorm_backward(tensor_t self, tensor_t scale, tensor_t bias, tensor_t y, tensor_t dscale, tensor_t dbias, tensor_t din, float eps) override;
